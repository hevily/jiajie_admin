<template>
  <div class="periodicReservation">
    <Modal v-model="show" class="periodicReservation" title="周期预约" :footer-hide="true" :closable="true" :mask-closable="false" :scrollable="true">
      <div class="close" slot="close" @click="close">X</div>
